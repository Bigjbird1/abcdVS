    ...
    <div>
      ...
      <div className="space-y-4">
        {messages.map((message) => (
          ...
          >
            <div
              className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${message.unread ? "bg-blue-100" : "bg-gray-100"}`}
            >
              <MessageCircle
                className={`w-5 h-5 ${message.unread ? "text-blue-600" : "text-gray-600"}`}
              />
            </div>
            <div className="flex-1">
              ...
              <p
                className={`mt-1 ${message.unread ? "font-medium" : "text-gray-600"}`}
              >
                {message.message}
              </p>
            </div>
